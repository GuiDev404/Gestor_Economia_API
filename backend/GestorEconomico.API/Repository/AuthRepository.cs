...
namespace GestorEconomico.API.Repository
{
    public class AuthRepository : IAuthRepository
    {
        ...
        public async Task<bool> SeedDefaultCuentas (){
            if(!_context.Cuentas.Any()){
                List<Cuenta> cuentasPorDefecto = new (){
                        new Cuenta {
                            Color = "",
                            Emoji = "💱",
                            Titulo = "Billetera",
                ...
                await _context.Cuentas.AddRangeAsync(cuentasPorDefecto);
                return await Save();
            }
        ...
        public async Task<bool> SeedDefaultCategories (){
            if(!_context.Categorias.Any()){
                List<Categoria> categoriasPorDefecto = new (){
                    new Categoria {
                        Color = "",
                        Emoji = "🥟",
                        Nombre = "Comida",
                        TipoEntrada = TiposEntradas.Egreso,
                        UsuarioID = "",
                    },
                    new Categoria {
                        Color = "",
                    ...
                    new Categoria {
                        ...
                        Emoji = "💴",
                        Nombre = "Sueldo",
                        TipoEntrada = TiposEntradas.Ingreso,
                        UsuarioID = "",
                    },
                    new Categoria {
                        Color = "",
